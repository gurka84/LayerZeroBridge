 ...
 */
export type Result = ElementaryResult | ArrayResult | MappingResult | StructResult | TupleResult | MagicResult | TypeResult | FunctionExternalResult | FunctionInternalResult | OptionsResult;
/**
 * An actual value, not an error (although if a container type it may contain errors!)
 *
 * @Category General categories
 */
export type Value = ElementaryValue | ArrayValue | MappingValue | StructValue | TupleValue | MagicValue | TypeValue | FunctionExternalValue | FunctionInternalValue | OptionsValue;
/**
 * A value that can go in the ABI
 *
 * @Category General categories
 */
export type AbiValue = UintValue | IntValue | BoolValue | BytesValue | AddressValue | FixedValue | UfixedValue | StringValue | ArrayValue | FunctionExternalValue | TupleValue;
/**
 * A result for an ABI type
 *
 * @Category General categories
 */
export type AbiResult = UintResult | IntResult | BoolResult | BytesResult | AddressResult | FixedResult | UfixedResult | StringResult | ArrayResult | FunctionExternalResult | TupleResult;
/**
 * An elementary value or error
 *
 * @Category General categories
 */
export type ElementaryResult = UintResult | IntResult | BoolResult | BytesResult | AddressResult | StringResult | FixedResult | UfixedResult | EnumResult | UserDefinedValueTypeResult | ContractResult;
/**
 ...
 * @Category Function types
 */
export type FunctionExternalValueInfo = FunctionExternalValueInfoKnown | FunctionExternalValueInfoInvalid | FunctionExternalValueInfoUnknown;
/**
 ...
 * @Category Function types
 */
export type FunctionInternalValueInfo = FunctionInternalValueInfoKnown | FunctionInternalValueInfoException | FunctionInternalValueInfoUnknown;
/**
