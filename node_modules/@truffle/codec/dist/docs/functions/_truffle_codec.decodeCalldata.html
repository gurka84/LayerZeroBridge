...
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> <span class="tsd-kind-parameter">isConstructor</span>: <span class="tsd-signature-type">boolean</span></h5></li></ul></div>
...
<ul>
<li>Defined in <a href="https://github.com/trufflesuite/truffle/blob/d9fdb7015/packages/codec/lib/core.ts#L52">codec/lib/core.ts:52</a></li></ul></aside></li></ul></section></div>
